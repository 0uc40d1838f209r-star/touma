...
// 記録後に表示するねぎらいの言葉(成果ごと)
export const ENCOURAGEMENTS: Record<VisitOutcome, string[]> = {
  new_client: [
    "🎉 新規獲得おめでとうございます!大きな一歩です。",
    "🎊 やりましたね!この調子で近隣にも広げましょう。",
    "🌟 素晴らしい成果です。お疲れさまでした!",
  ],
  consult: [
    "👍 相談につながりましたね!1週間以内のフォローが決め手です。",
    "🙌 いい流れです。次の一手で新規につなげましょう。",
    "✨ 手ごたえアリ。記録お疲れさまでした!",
  ],
  greeting: [
    "お疲れさまでした!顔を出す積み重ねが信頼になります。",
    "🚶 1件ずつが未来の紹介につながります。ナイス営業!",
    "💪 コツコツが一番の近道。今日もお疲れさまです!",
  ],
  other: [
    "記録ありがとうございます!1件1件が力になります。",
    "お疲れさまでした!振り返りが次の成果をつくります。",
  ],
};
// 不在だったときの専用メッセージ
export const ABSENT_ENCOURAGEMENTS = [
  "残念、不在でしたね。でも足を運んだ事実が次につながります。名刺+資料を置けたら◎",
  "空振りも営業のうち。次回は時間帯を変えて再チャレンジ!お疲れさまでした。",
];
